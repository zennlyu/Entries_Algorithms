package com.algorithms.princeton.BSorting.ElementarySort;

/******************************************************************************
 *  Compilation:  javac com.algorithms.princeton.BSorting.ElementarySort.InsertionPedantic.java
 *  Execution:    java com.algorithms.princeton.BSorting.ElementarySort.InsertionPedantic < input.txt
 ...
 *
 *  % java com.algorithms.princeton.BSorting.ElementarySort.InsertionPedantic < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *
 *  % java com.algorithms.princeton.BSorting.ElementarySort.InsertionPedantic < words3.txt
